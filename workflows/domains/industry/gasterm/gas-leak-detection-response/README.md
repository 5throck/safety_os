...
## 1. 목적
본 워크플로우는 한국 가스안전 관련 법령(고압가스안전관리법 (High-Pressure Gas Safety Control Act) 제17조, 액화석유가스의 안전관리 및 사업법 (LPG Safety Control and Business Act) 제30조)에 따른 가스누출 탐지 및 대응 업무를 수행한다.
