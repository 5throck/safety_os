...
| # | 문서 | 학습 내용 |
|---|------|-----------|
| 1 | **[사용자 시나리오](docs/_shared/user-scenarios_ko.md)** | 5개 실전 워크스루: 신규 화학물질 도입, 임상 SAE 보고, 건설 일일 안전, 의약품 냉장유통, 화학공장 정기보수 |
| 2 | **[사용자 가이드](docs/_shared/user-guide.md)** | 올바른 도메인 선택과 에이전트 dispatch 패턴 (매트릭스 코디네이터) |
| 3 | **[도메인 분류 가이드](docs/_shared/domain-classification-guide.md)** | 3-tier 체계 (기능/산업/공통) — 각 도메인이 담당하는 영역 |
...
> `✓` = 해당 산업에 기능 서비스 적용 · `●` = 산업 도메인이 해당 열(산업)을 담당 · `—` = 해당 없음
>
> **산업 도메인 = 매트릭스 코디네이터.** 공정안전(PSM), 화학데이터(MSDS), 교육(Training) 등 기능 서비스에 dispatch합니다. [자세히 보기 →](docs/_shared/domain-classification-guide.md)
...
| **[도메인 분류 가이드](docs/_shared/domain-classification-guide.md)** | 3-tier 분류 + 매트릭스 dispatch | EN |

### 아키텍처 및 설계
| 문서 | 용도 |
|------|------|
| [아키텍처 개요](docs/_meta/architecture-overview.md) | 13-도메인 시스템 아키텍처 |
| [도메인 추가 가이드](docs/_shared/domain-onboarding-guide.md) | 신규 도메인 11단계 SOP + Active Domains Registry |
| [Reference 워크플로우 패턴](docs/_shared/reference-workflow-pattern.md) | Reference 워크플로우 설계 (10개 적용) |
...
| 도메인 | Scope |
|--------|-------|
| 기능 | [GMP](docs/domains/functional/gmp/scope.md) · [GDP](docs/domains/functional/gdp/scope.md) · [GLP](docs/domains/functional/glp/scope.md) · [GCP](docs/domains/functional/gcp/scope.md) · [GVP](docs/domains/functional/gvp/scope.md) · [MSDS](docs/domains/functional/msds/scope.md) · [Training](docs/domains/functional/training/scope.md) |
| 산업 | [ehsconst](docs/domains/industry/ehsconst/scope.md) · [ehschem](docs/domains/industry/ehschem/scope.md) · [gasterm](docs/domains/industry/gasterm/scope.md) · [powergen](docs/domains/industry/powergen/scope.md) · [meddevice](docs/domains/industry/meddevice/scope.md) |
...
```
agents/domains/functional/     ← PSM, MSDS, GxP, Training 에이전트
agents/domains/industry/       ← ehsconst, ehschem, gasterm, powergen, meddevice 에이전트
